        ...
        <div className="w-[150px] shrink-0">
          <p
            className={`text-[11.5px] font-semibold ${
              variant === "overdue" ? "text-hot" : "text-dash-muted"
            }`}
          >
            {variant === "completed"
          ...
          <p className="text-[11px] text-dash-muted">
            Due {formatDate(followUp.due_date)} · {formatTime(followUp.due_time)}
          </p>
        </div>
        ...
        <div className="overflow-hidden rounded-lg border border-dash-border bg-sidebar shadow-sm">
          ...
          <div className="bg-white">
            ...
            {!isLoading && items.length === 0 && (
              <p className="px-6 py-10 text-center text-sm text-dash-placeholder">{emptyText}</p>
            )}
